...
// e.g. "uploads\\ocr_uploads\\file.pdf" → "<API_BASE>/uploads/ocr_uploads/file.pdf"
  ...
  if (!result) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
        ...
        <h2 className="text-foreground">No OCR result available</h2>
        <p className="text-muted-foreground max-w-sm">
          Upload a document first to see the extracted fields here.
        </p>
        <button
