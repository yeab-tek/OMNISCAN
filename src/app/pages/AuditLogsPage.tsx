import { Clock, User, Edit, Trash2, FileText, CheckCircle, Lock, Loader2, Download, LogIn, X } from 'lucide-react';
...
export function AuditLogsPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setLogs([]);
      setTotal(0);
      setError(err instanceof ApiError ? err.message : 'Could not load audit logs. Check your connection.');
    } finally {
      setIsLoading(false);
    }
  };
