      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-card">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground space-y-1">
            ...
            <p className="text-xs mt-2 text-primary font-medium">Demo mode: use any password with these emails:</p>
            <p className="text-xs">admin / trade / dataentry / finance @lataagriexport.com</p>
          </div>
        </div>
      </div>
